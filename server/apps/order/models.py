...
class Order(models.Model):
    ...
    status = models.PositiveSmallIntegerField(verbose_name='Статус заказа', default=1, choices=STATUS_CHOICES)
...
class OrderComment(models.Model):
    order = models.ForeignKey(Order, verbose_name='Заказ', on_delete=models.CASCADE, related_name='comment')
    profile = models.ForeignKey(Profile, verbose_name='Профлиль', on_delete=models.CASCADE)
